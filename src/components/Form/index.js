        ...
        <form className="form" onSubmit={mailValid && phone.length > 0 && name.length > 0 ?  handleFormSubmit : undefined} ref={applyRef}>
            <div className="form__field-container">
                <Field 
                    ...
                    value={name}
                />
                <div className={name.length > 0 ? 'form__circle':'form__circle form__circle--modifier'}></div>
            </div>
            <div className="form__field-container">
                <Field 
                    type="tel"
                    ...
                    value={phone}
                />
                <div className={phone.length > 0 ? 'form__circle':'form__circle form__circle--modifier'}></div>
            </div>
            <div className="form__field-container">
                <Field 
                    type="email"
                ...
                <div className={mailValid ? 'form__circle':'form__circle form__circle--modifier'}></div>
            </div>
            <button 
